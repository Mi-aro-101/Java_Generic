...
public class GenericDao {
     ...
     * @throws Exception
     */
    public static <T> List<T> getAll(Class<T> myclass)throws Exception{
        List<T> results = new ArrayList<>();
        // Instanciating a new Connection
        Connection c = GenericDac.generate();
     ...
     * @throws Exception 
     */
    public static <T,K> T findById(Class<T> myclass, K key )throws Exception{
        T result = null;
     ...
     * @throws Exception 
     */
    public static <T> void insert(T entity)throws Exception{
        Connection c = GenericDac.generate();
     ...
     * @throws Exception 
     */
    public static <T> void remove(T entity)throws Exception{
        Connection c = GenericDac.generate();
    ...
    public static <T> void update(T entity)throws Exception{
        Connection c = GenericDac.generate();
...
////////////////////////////////////////////////////////////////////////////////////
    ...
    // THE SAME METHODS BUT YOU CAN PROVIDE A CONNECTION FOR THEM
    /**
     * Find an Object from database by its Id
     * @param <T>
     * @param <K>
     ...
     * @throws Exception 
     */
    public static <T,K> T findByIdWithConnection(Connection c, Class<T> myclass, K key)throws Exception{
        T result = null;
